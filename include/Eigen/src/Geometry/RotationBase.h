...
class RotationBase
{
  ...
  public:
    ...
    friend EIGEN_DEVICE_FUNC inline Transform<Scalar,Dim,Affine> operator*(const DiagonalMatrix<Scalar,Dim>& l, const Derived& r)
    { 
...
struct rotation_base_generic_product_selector<RotationDerived,MatrixType,false>
{
  ...
  static EIGEN_DEVICE_FUNC inline ReturnType run(const RotationDerived& r, const MatrixType& m)
...
struct rotation_base_generic_product_selector< RotationDerived, DiagonalMatrix<Scalar,Dim,MaxDim>, false >
{
  ...
  static EIGEN_DEVICE_FUNC inline ReturnType run(const RotationDerived& r, const DiagonalMatrix<Scalar,Dim,MaxDim>& m)
  {
    ReturnType res(r);
    res.linear() *= m;
    return res;
...
static EIGEN_DEVICE_FUNC inline Matrix<Scalar,2,2> toRotationMatrix(const Scalar& s)
{
...
static EIGEN_DEVICE_FUNC inline Matrix<Scalar,Dim,Dim> toRotationMatrix(const RotationBase<OtherDerived,Dim>& r)
{
  return r.toRotationMatrix();
}

template<typename Scalar, int Dim, typename OtherDerived>
static EIGEN_DEVICE_FUNC inline const MatrixBase<OtherDerived>& toRotationMatrix(const MatrixBase<OtherDerived>& mat)
{
